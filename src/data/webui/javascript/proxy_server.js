...
function reload_media_count()
{
    sendRequest({
        ...
        function(response) {
            ...
            var found = false,
                categories = ["Детские", "Общие", "Познавательные", "Развлекательные", "Фильмы", "Мужские", "Музыкальные", "Новости", "Эротика", "Региональные", "Религиозные", "Спорт", "tv", "movies", "music_video", "music", "other"];
